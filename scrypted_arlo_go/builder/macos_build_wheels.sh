...
build_wheel() (
    ...
    /usr/local/bin/python_for_build -m pip install cibuildwheel==2.16.2 setuptools https://github.com/bjia56/pybindgen/archive/pypy-fixes.zip --break-system-packages
