...
export CIBW_BEFORE_ALL_LINUX="curl -o go.tar.gz https://dl.google.com/go/go1.21.6.linux-amd64.tar.gz; tar -C /usr/local -xzf go.tar.gz; go install github.com/go-python/gopy@v0.4.5; go install golang.org/x/tools/cmd/goimports@latest"
